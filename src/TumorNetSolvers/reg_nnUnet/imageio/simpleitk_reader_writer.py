...
class SimpleITKIO2(BaseReaderWriter):
    ...
    def write_seg(self, img: np.ndarray, output_fname: str, properties: dict) -> None:
        assert img.ndim in [3, 4], 'Image must be 3D or 4D'
